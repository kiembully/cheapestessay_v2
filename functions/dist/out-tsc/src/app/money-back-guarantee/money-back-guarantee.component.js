...
let MoneyBackGuaranteeComponent = class MoneyBackGuaranteeComponent {
    constructor(titleService, metaTagService) {
        this.titleService = titleService;
        this.metaTagService = metaTagService;
        this.panelMoneyBackState = false;
        this.mgbContents = [
            {
    ...
    ngOnInit() {
        ...
        this.metaTagService.updateTag({ name: 'description', content: "We ensure that you stay happy after ordering an essay, so all orders are covered under the Cheapest Essay Money Back Guarantee but check our full policy guidelines." });
        this.metaTagService.updateTag({ name: 'keywords', content: "money back guarantee" });
    }
};
MoneyBackGuaranteeComponent = __decorate([
    Component({
...
export { MoneyBackGuaranteeComponent };
//# sourceMappingURL=money-back-guarantee.component.js.map