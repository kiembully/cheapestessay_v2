...
let FaqsComponent = class FaqsComponent {
    ...
    ngOnInit() {
        ...
        this.metaTagService.updateTag({ name: 'description', content: "Do you have questions about our writing service? Want to know how it works then read the answers at FAQs on our site and learn more about our service." });
        this.metaTagService.updateTag({ name: 'keywords', content: "faqs" });
    }
    selectPanel(index) {
