...
let ContentPhotoInfoComponent = class ContentPhotoInfoComponent {
    constructor() {
        this.has_header = false;
        this.has_order_button = false;
        this.has_contact_button = false;
        this.has_diagonal_background = false;
        this.has_background_content = false;
        this.is_faqs_content = false;
        this.is_disclaimer_content = false;
        this.about_services = [
            {
...
__decorate([
    Input()
], ContentPhotoInfoComponent.prototype, "left_first", void 0);
__decorate([
    Input()
], ContentPhotoInfoComponent.prototype, "data_content", void 0);
__decorate([
    Input()
], ContentPhotoInfoComponent.prototype, "has_header", void 0);
__decorate([
    Input()
], ContentPhotoInfoComponent.prototype, "has_order_button", void 0);
__decorate([
    Input()
], ContentPhotoInfoComponent.prototype, "has_contact_button", void 0);
__decorate([
    Input()
], ContentPhotoInfoComponent.prototype, "has_diagonal_background", void 0);
__decorate([
    Input()
], ContentPhotoInfoComponent.prototype, "has_background_content", void 0);
__decorate([
    Input()
], ContentPhotoInfoComponent.prototype, "is_faqs_content", void 0);
__decorate([
    Input()
], ContentPhotoInfoComponent.prototype, "is_disclaimer_content", void 0);
ContentPhotoInfoComponent = __decorate([
    Component({
...
export { ContentPhotoInfoComponent };
//# sourceMappingURL=content-photo-info.component.js.map