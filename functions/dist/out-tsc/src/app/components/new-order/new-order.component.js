...
let NewOrderComponent = class NewOrderComponent {
    constructor(_auth, _data, _session, dialog, _dialog_trigger) {
        this._auth = _auth;
        this._data = _data;
        ...
        this.panelOptionalState = false;
        // order ouput on floating element
        this.orderOutput = this._data.orderOutput;
        ...
        this.frmDeleteMaterial = new FormGroup({
        ...
        this.deadlineFormat = '(Calculating...)';
        this.tooltip = [
    ...
    displayOldWriters() {
        this._auth.getOldWriters(this.tokenForm.value).subscribe(res => {
    ...
    deleteFile(name) {
        ...
        this._auth.deleteFiles(this.frmDeleteMaterial.value).subscribe(res => {
            this.isProgressLoading = false;
            if (res.status) {
...
__decorate([
    Input()
], NewOrderComponent.prototype, "isEditing", void 0);
