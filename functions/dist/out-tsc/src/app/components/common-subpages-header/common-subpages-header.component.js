...
let CommonSubpagesHeaderComponent = class CommonSubpagesHeaderComponent {
    constructor() {
        this.header_content = [
            {
...
__decorate([
    Input()
], CommonSubpagesHeaderComponent.prototype, "data_index", void 0);
__decorate([
    Input()
], CommonSubpagesHeaderComponent.prototype, "has_img", void 0);
CommonSubpagesHeaderComponent = __decorate([
    Component({
...
export { CommonSubpagesHeaderComponent };
//# sourceMappingURL=common-subpages-header.component.js.map