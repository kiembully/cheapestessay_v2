...
let CommonGuaranteesContentComponent = class CommonGuaranteesContentComponent {
    constructor() {
        this.guarantees = [
            {
                data: [
...
CommonGuaranteesContentComponent = __decorate([
    Component({
        selector: 'app-common-guarantees-content',
        templateUrl: './common-guarantees-content.component.html',
        styleUrls: ['./common-guarantees-content.component.css'],
        encapsulation: ViewEncapsulation.None,
    })
], CommonGuaranteesContentComponent);
export { CommonGuaranteesContentComponent };
//# sourceMappingURL=common-guarantees-content.component.js.map